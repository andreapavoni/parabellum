...
impl Command for CompleteAcademyResearch {
    ...
    async fn handle(&self, aggregate: &Self::Aggregate) -> Result<Vec<VillageEvent>, CqrsError> {
        ...
        Ok(vec![VillageEvent::AcademyResearchCompleted {
...
mod tests {
    ...
    use crate::villages::{CompleteAcademyResearch, VillageAggregate, VillageEvent};
    ...
    async fn rejects_wrong_target() {
        ...
        let result = CompleteAcademyResearch {
