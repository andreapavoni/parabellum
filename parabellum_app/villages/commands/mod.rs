...
pub use complete_attack_return::CompleteAttackReturn;
...
pub use complete_reinforcements_return::CompleteReinforcementsReturn;
pub use complete_scout_arrival::CompleteScoutArrival;
pub use complete_scout_return::CompleteScoutReturn;
...
pub use conquer_village::ConquerVillage;
