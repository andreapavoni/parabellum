...
#[derive(Debug, Clone)]
/// Completes a returning army trip (attack/raid/scout) at home village.
pub struct CompleteArmyReturn {
    pub action_id: Uuid,
...
impl Command for CompleteArmyReturn {
    ...
    async fn handle(&self, aggregate: &Self::Aggregate) -> Result<Vec<VillageEvent>, CqrsError> {
        ...
        Ok(vec![VillageEvent::ArmyReturned {
