...
impl fmt::Display for VillageEvent {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        let name = match self {
            ...
            VillageEvent::ReinforcementsReturned { .. } => "ReinforcementsReturned",
            ...
            VillageEvent::AttackReturned { .. } => "AttackReturned",
            VillageEvent::ScoutSent { .. } => "ScoutSent",
            VillageEvent::ScoutArrived { .. } => "ScoutArrived",
            VillageEvent::ScoutReturned { .. } => "ScoutReturned",
