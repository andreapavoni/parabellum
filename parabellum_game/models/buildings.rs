...
impl Building {
    ...
    pub fn calculate_build_time_secs(&self, server_speed: &i8, mb_level: &u8) -> u32 {
        ...
        let build_time_bonus = mb_factor as f64 / 1000.0;
        let final_time = (base_time * build_time_bonus) / (*server_speed) as f64;
        final_time.floor().max(1.0) as u32
    }
...
static CLAY_PIT: BuildingData = BuildingData {
    data: &[
        ...
        BuildingValueData(37645, 18820, 37645, 23525, 2, 11, 495, 155420),
        BuildingValueData(62865, 31430, 62865, 39290, 2, 13, 635, 248870),
        BuildingValueData(104985, 52490, 104985, 65615, 2, 15, 800, 398390),
        BuildingValueData(175320, 87660, 175320, 109575, 3, 18, 1000, 637620),
        BuildingValueData(292790, 146395, 292790, 182995, 3, 22, 1300, 1020390),
        BuildingValueData(488955, 244480, 488955, 305600, 3, 27, 1600, 1632820),
        BuildingValueData(816555, 408280, 816555, 510350, 3, 32, 2000, 2612710),
        BuildingValueData(1363650, 681825, 1363650, 852280, 3, 38, 2450, 4180540),
    ],
    group: BuildingGroup::Resources,
    rules: BuildingRules {
        requirements: &[],
...
static IRON_MINE: BuildingData = BuildingData {
    data: &[
        ...
        BuildingValueData(47055, 37645, 14115, 28230, 3, 11, 495, 220160),
        BuildingValueData(78580, 62865, 23575, 47150, 3, 13, 635, 352450),
        BuildingValueData(131230, 104985, 39370, 78740, 3, 15, 800, 564120),
        BuildingValueData(219155, 175320, 65745, 131490, 3, 18, 1000, 902760),
        BuildingValueData(365985, 292790, 109795, 219590, 3, 22, 1300, 145546),
        BuildingValueData(611195, 488955, 183360, 366715, 3, 27, 1600, 2311660),
        BuildingValueData(1020695, 816555, 306210, 612420, 3, 32, 2000, 3698850),
        BuildingValueData(1704565, 1363650, 511370, 1022740, 3, 38, 2450, 5918370),
    ],
    group: BuildingGroup::Resources,
    rules: BuildingRules {
        requirements: &[],
...
static BARRACKS: BuildingData = BuildingData {
    data: &[
        ...
        BuildingValueData(925, 615, 1145, 530, 3, 4, 531, 7570),
        BuildingValueData(1180, 790, 1465, 675, 3, 4, 478, 9080),
        BuildingValueData(1515, 1010, 1875, 865, 3, 5, 430, 10830),
        BuildingValueData(1935, 1290, 2400, 1105, 3, 6, 387, 12860),
        BuildingValueData(2480, 1655, 3070, 1415, 3, 7, 349, 15220),
        BuildingValueData(3175, 2115, 3930, 1815, 3, 9, 314, 17950),
        BuildingValueData(4060, 2710, 5030, 2320, 3, 11, 282, 21130),
        BuildingValueData(5200, 3465, 6435, 2970, 3, 13, 254, 24810),
        BuildingValueData(6655, 4435, 8240, 3805, 3, 15, 229, 29080),
        BuildingValueData(8520, 5680, 10545, 4870, 4, 18, 206, 34030),
        BuildingValueData(10905, 7270, 13500, 6230, 4, 22, 185, 39770),
        BuildingValueData(13955, 9305, 17280, 7975, 4, 27, 167, 46440),
        BuildingValueData(17865, 11910, 22120, 10210, 4, 32, 150, 54170),
        BuildingValueData(22865, 15245, 28310, 13065, 4, 38, 135, 63130),
    ],
    group: BuildingGroup::Military,
    rules: BuildingRules {
        requirements: &[
...
static STABLE: BuildingData = BuildingData {
    data: &[
        BuildingValueData(260, 140, 220, 100, 5, 2, 1000, 2200),
        BuildingValueData(335, 180, 280, 130, 3, 3, 900, 2850),
        BuildingValueData(425, 230, 360, 165, 3, 3, 811, 3610),
        BuildingValueData(545, 295, 460, 210, 3, 4, 729, 4490),
        BuildingValueData(700, 375, 590, 270, 3, 5, 656, 5500),
        BuildingValueData(895, 480, 755, 345, 3, 6, 590, 6680),
        BuildingValueData(1145, 615, 970, 440, 3, 7, 531, 8050),
        BuildingValueData(1465, 790, 1240, 565, 3, 9, 478, 9640),
        BuildingValueData(1875, 1010, 1585, 720, 3, 10, 430, 11480),
        BuildingValueData(2400, 1290, 2030, 920, 3, 12, 387, 13620),
        BuildingValueData(3070, 1655, 2595, 1180, 4, 15, 349, 16100),
        BuildingValueData(3930, 2115, 3325, 1510, 4, 18, 314, 18980),
        BuildingValueData(5030, 2710, 4255, 1935, 4, 21, 282, 22310),
        BuildingValueData(6435, 3465, 5445, 2475, 4, 26, 254, 26180),
        BuildingValueData(8240, 4435, 6970, 3170, 4, 31, 229, 30670),
        BuildingValueData(10545, 5680, 8925, 4055, 4, 37, 206, 35880),
        BuildingValueData(13500, 7270, 11425, 5190, 4, 44, 185, 41920),
        BuildingValueData(17280, 9305, 14620, 6645, 4, 53, 167, 48930),
        BuildingValueData(22120, 11910, 18715, 8505, 4, 64, 150, 57060),
        BuildingValueData(28310, 15245, 23955, 10890, 4, 77, 135, 66490),
    ],
    group: BuildingGroup::Military,
    rules: BuildingRules {
        requirements: &[
...
static WORKSHOP: BuildingData = BuildingData {
    data: &[
        BuildingValueData(460, 510, 600, 320, 3, 4, 1000, 3000),
        BuildingValueData(590, 655, 770, 410, 2, 4, 900, 3780),
        BuildingValueData(755, 835, 985, 525, 2, 5, 81, 4680),
        BuildingValueData(965, 1070, 1260, 670, 2, 6, 729, 5730),
        BuildingValueData(1235, 1370, 1610, 860, 2, 7, 656, 6950),
        BuildingValueData(1580, 1750, 2060, 1100, 2, 9, 590, 8360),
        BuildingValueData(2025, 2245, 2640, 1405, 2, 11, 531, 10000),
        BuildingValueData(2590, 2870, 3380, 1800, 2, 13, 478, 11900),
        BuildingValueData(3315, 3675, 4325, 2305, 2, 15, 430, 14110),
        BuildingValueData(4245, 4705, 5535, 2950, 2, 19, 387, 16660),
        BuildingValueData(5430, 6020, 7085, 3780, 3, 22, 349, 19630),
        BuildingValueData(6950, 7705, 9065, 4835, 3, 27, 314, 23070),
        BuildingValueData(8900, 9865, 11605, 6190, 3, 32, 282, 27060),
        BuildingValueData(11390, 12625, 14855, 7925, 3, 39, 254, 31690),
        BuildingValueData(14580, 16165, 19015, 10140, 3, 46, 229, 37060),
        BuildingValueData(18660, 20690, 24340, 12980, 3, 55, 206, 43290),
        BuildingValueData(23885, 26480, 31155, 16615, 3, 67, 185, 50520),
        BuildingValueData(30570, 33895, 39875, 21270, 3, 80, 167, 58900),
        BuildingValueData(39130, 43385, 51040, 27225, 3, 96, 150, 68630),
        BuildingValueData(50090, 55535, 65335, 34845, 3, 115, 135, 79910),
    ],
    group: BuildingGroup::Military,
    rules: BuildingRules {
        requirements: &[
...
static GREAT_BARRACKS: BuildingData = BuildingData {
    data: &[
        ...
        BuildingValueData(2775, 1845, 3435, 1590, 3, 4, 531, 7570),
        BuildingValueData(3540, 2370, 4395, 2025, 3, 4, 478, 9080),
        BuildingValueData(4545, 3030, 5625, 2595, 3, 5, 430, 10830),
        BuildingValueData(5805, 3870, 7200, 3315, 3, 6, 387, 12860),
        BuildingValueData(7460, 4965, 9210, 4245, 3, 7, 349, 15220),
        BuildingValueData(9525, 6345, 11790, 5445, 3, 9, 314, 17950),
        BuildingValueData(12180, 8130, 15090, 6960, 3, 11, 282, 21130),
        BuildingValueData(15600, 10395, 19305, 8910, 3, 13, 254, 24810),
        BuildingValueData(19965, 13305, 24720, 11415, 3, 15, 229, 29080),
        BuildingValueData(25560, 17040, 31635, 14610, 4, 18, 206, 34030),
        BuildingValueData(32715, 21810, 40500, 18690, 4, 22, 185, 39770),
        BuildingValueData(41870, 27915, 51840, 23925, 4, 27, 167, 46440),
        BuildingValueData(53595, 35730, 66360, 30630, 4, 32, 15, 54170),
        BuildingValueData(68595, 45735, 84930, 39195, 4, 38, 135, 63130),
    ],
    group: BuildingGroup::Military,
    rules: BuildingRules {
...
static GREAT_STABLE: BuildingData = BuildingData {
    data: &[
        BuildingValueData(780, 420, 660, 300, 5, 2, 1000, 2200),
        BuildingValueData(1000, 540, 845, 385, 3, 3, 900, 2850),
        BuildingValueData(1280, 690, 1080, 490, 3, 3, 81, 3610),
        BuildingValueData(1635, 880, 1385, 630, 3, 4, 729, 4490),
        BuildingValueData(2095, 1125, 1770, 805, 3, 5, 656, 5500),
        BuildingValueData(2680, 1445, 2270, 1030, 3, 6, 590, 6680),
        BuildingValueData(3430, 1845, 2905, 1320, 3, 7, 531, 8050),
        BuildingValueData(4390, 2365, 3715, 1690, 3, 9, 478, 9640),
        BuildingValueData(5620, 3025, 4755, 2160, 3, 10, 430, 11480),
        BuildingValueData(7195, 3875, 6085, 2765, 3, 12, 387, 13620),
        BuildingValueData(9210, 4960, 7790, 3540, 4, 15, 349, 16100),
        BuildingValueData(11785, 6345, 9975, 4535, 4, 18, 314, 18980),
        BuildingValueData(15085, 8125, 12765, 5805, 4, 21, 282, 22310),
        BuildingValueData(19310, 10400, 16340, 7430, 4, 26, 254, 26180),
        BuildingValueData(24720, 13310, 20915, 9505, 4, 31, 229, 30670),
        BuildingValueData(31640, 17035, 26775, 12170, 4, 37, 206, 35880),
        BuildingValueData(40500, 21810, 34270, 15575, 4, 44, 185, 41920),
        BuildingValueData(51840, 27915, 43865, 19940, 4, 53, 167, 48930),
        BuildingValueData(66355, 35730, 56145, 25520, 4, 64, 15, 57060),
        BuildingValueData(84935, 45735, 71870, 32665, 4, 77, 135, 66490),
    ],
    group: BuildingGroup::Military,
    rules: BuildingRules {
...
static HORSE_DRINKING_TROUGH: BuildingData = BuildingData {
    data: &[
        BuildingValueData(400, 500, 350, 100, 1, 1, 99, 7000),
        BuildingValueData(510, 640, 450, 130, 1, 1, 98, 8420),
        BuildingValueData(655, 820, 575, 165, 1, 2, 97, 10070),
        BuildingValueData(840, 1050, 735, 210, 1, 2, 96, 11980),
        BuildingValueData(1075, 1340, 940, 270, 1, 2, 95, 14190),
        BuildingValueData(1375, 1720, 1205, 345, 1, 3, 94, 16770),
        BuildingValueData(1760, 2200, 1540, 440, 1, 4, 93, 19750),
        BuildingValueData(2250, 2815, 1970, 565, 1, 4, 92, 23210),
        BuildingValueData(2880, 3605, 2520, 720, 1, 5, 91, 27220),
        BuildingValueData(3690, 4610, 3230, 920, 1, 6, 90, 31880),
        BuildingValueData(4720, 5905, 4130, 1180, 2, 7, 89, 37280),
        BuildingValueData(6045, 7555, 5290, 1510, 2, 9, 88, 43540),
        BuildingValueData(7735, 9670, 6770, 1935, 2, 11, 87, 50810),
        BuildingValueData(9905, 12380, 8665, 2475, 2, 13, 86, 59240),
        BuildingValueData(12675, 15845, 11090, 3170, 2, 15, 85, 69010),
        BuildingValueData(16225, 20280, 14200, 4055, 2, 18, 84, 80360),
        BuildingValueData(20770, 25960, 18175, 5190, 2, 22, 83, 93510),
        BuildingValueData(26585, 33230, 23260, 6645, 2, 27, 82, 108_780),
        BuildingValueData(34030, 42535, 29775, 8505, 2, 32, 81, 126_480),
        BuildingValueData(43555, 54445, 38110, 10890, 2, 38, 80, 147_020),
    ],
    group: BuildingGroup::Infrastructure,
    rules: BuildingRules {
        requirements: &[
...
static GREAT_WORKSHOP: BuildingData = BuildingData {
    data: &[
        BuildingValueData(1380, 1530, 1800, 960, 3, 4, 1000, 3000),
        BuildingValueData(1770, 1915, 2310, 1230, 2, 4, 900, 3780),
        BuildingValueData(2215, 2505, 2955, 1575, 2, 5, 81, 4680),
        BuildingValueData(2895, 3210, 3780, 2010, 2, 6, 729, 5730),
        BuildingValueData(3705, 4110, 4830, 2580, 2, 7, 656, 6950),
        BuildingValueData(4740, 5250, 6180, 3300, 2, 9, 590, 8360),
        BuildingValueData(6075, 6735, 7920, 4215, 2, 11, 531, 10000),
        BuildingValueData(7730, 8610, 10140, 5600, 2, 13, 478, 11900),
        BuildingValueData(9945, 11025, 12975, 4615, 2, 15, 430, 14110),
        BuildingValueData(12735, 14115, 16605, 8850, 2, 19, 387, 16660),
        BuildingValueData(16290, 18060, 23415, 11340, 3, 22, 349, 19630),
        BuildingValueData(20850, 23115, 27195, 14505, 3, 27, 314, 23070),
        BuildingValueData(26700, 29595, 34815, 18570, 3, 32, 282, 27060),
        BuildingValueData(34170, 37875, 44565, 23775, 3, 39, 254, 31690),
        BuildingValueData(43740, 48495, 57045, 30420, 3, 46, 229, 37060),
        BuildingValueData(55980, 62070, 73020, 38940, 3, 55, 206, 43290),
        BuildingValueData(71655, 79440, 93465, 49485, 3, 67, 185, 50520),
        BuildingValueData(91710, 101_685, 119_625, 63810, 3, 80, 167, 58900),
        BuildingValueData(105_650, 117_140, 137_810, 73510, 3, 96, 15, 68630),
        BuildingValueData(125_225, 138_840, 159_995, 87090, 3, 115, 135, 79910),
    ],
    group: BuildingGroup::Military,
    rules: BuildingRules {
