...
static STABLE: BuildingData = BuildingData {
    data: &[
        ...
        BuildingValueData(1875, 1010, 1585, 720, 3, 10, 4303, 11480),
        BuildingValueData(2400, 1290, 2030, 920, 3, 12, 387, 13620),
        BuildingValueData(3070, 1655, 2595, 1180, 4, 15, 3495, 16100),
        BuildingValueData(3930, 2115, 3325, 1510, 4, 18, 3141, 18980),
